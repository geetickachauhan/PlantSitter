    ...
    <div class="container">
        <div class="navbar-collapse collapse" id="main-navbar">
            <ul class="navbar-nav nav-fill w-100">
                <li class="nav-item mt-1"><a class="nav-link" href="#">My Plants</a></li>
                ...
                <li class="nav-item dropdown text-right mt-1"><a class="nav-link dropdown-toggle" href="#" id="username" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item" href="#"><span class="fas fa-id-card fa-lg text-gray margin-right"></span>Profile and Calendar</a>
                        <a class="dropdown-item" href="#"><span class="fas fa-camera fa-lg text-gray margin-right"></span>Photos by Volunteers</a><div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><span class="fas fa-sign-out-alt fa-lg text-gray margin-right"></span>Signout</a></div>
            </li></ul></div></div>`;
